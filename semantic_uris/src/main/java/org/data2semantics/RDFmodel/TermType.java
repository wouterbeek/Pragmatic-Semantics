...
public class TermType {
	...
	public static int ix2id(int type, int ix) {
		return ix * SIZE + type;
	}

	public static int id2ix(int id) {
		return id / SIZE;
	}

	public static int id2type(int id) {
		return id % SIZE;
	}

	public static boolean is_named(int id)   { return id2type(id)==NAMED; }
	public static boolean is_bnode(int id)   { return id2type(id)==BNODE; }
	public static boolean is_literal(int id) { return id2type(id)==LITERAL; }
	...
	public static int named2id(int i) { return ix2id(NAMED, i); }
	public static int bnode2id(int i) { return ix2id(BNODE, i); }
	public static int lit2id(int i) { return ix2id(LITERAL, i); }
